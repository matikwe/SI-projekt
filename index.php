...
$actions = array('logout', 'login', 'registration', 'home', 'about', 'contact', 'searchResults', 'articles','userModification','contactPanel','addPost', 'chat', 'userPanel'); //wpisywać stworzone podstrony
